...
public class SalesterritoryhistoryPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		System.out.println("BID "+this.businessentityid+" vs "+castOther.businessentityid);
		System.out.println("StartDate "+this.startdate+" vs "+castOther.startdate);
		System.out.println("TerrId "+this.territoryid+" vs "+castOther.territoryid);
